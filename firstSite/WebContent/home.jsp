...
<body>
	<div class="header">
		<div class="container">
			...
			<div class="row">
				<div class="col-2">
					<h1>Perfect Sublimation Printings</h1>
					<br>
					<h3>Store your memories with you!</h3>

					<a href="./ImageViewerController" class="btn">Explore Now
						&#8594</a>
				</div>
				<div class="col-2">
	...
	<div class="offer">
		<div class="small-container">
			<div class="row">
				...
				<div class="col-0">
					<p>Exclusively Available the similar kind of Mobile Covers on
						Store</p>
					<h1>Perfect Sublimation</h1>
					<small>We provide mobile cover prints for all the mobile
						phones cover with awesome printed design.</small>
					<div>
						<a href="./ImageViewerController" class="btn"> Buy Now &#8594</a>
					</div>
				</div>
			</div>
		</div>
