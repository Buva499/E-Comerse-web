...
@WebServlet("/CustomerImageViewerController")
public class CustomerImageViewerController extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse responce) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("CustomerMainPage.jsp");
